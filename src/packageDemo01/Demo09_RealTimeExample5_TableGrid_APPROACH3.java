...
public class Demo09_RealTimeExample5_TableGrid_APPROACH3 {

	/*APPROACH 3: Using CSS Selector based ancestor-child relationship ( :nth-child())
	 * and using XPATH based sibling-to-sibling relationship (/following-sibling::)
	 */
	public static void main(String[] args) {
		...
		*/
		...
		/*Extract the Extras
		*/
		String extras = parentOrTable.findElement(By.xpath("(//div[text()='Extras'])[1]/following-sibling::div[1]")).getText();
		...
		/*Extract the Totals
		*/
		String total = parentOrTable.findElement(By.xpath("(//div[text()='Total'])[1]/following-sibling::div[1]")).getText();
